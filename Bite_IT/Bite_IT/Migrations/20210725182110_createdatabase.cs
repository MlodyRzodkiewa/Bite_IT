    ...
    public partial class createdatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealsIngredients", x => new { x.IngredientsId, x.MealsId });
                    table.ForeignKey(
                        name: "FK_MealsIngredients_Ingredients_IngredientsId",
                        column: x => x.IngredientsId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealsIngredients_Meals_MealsId",
                        column: x => x.MealsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdersMeals", x => new { x.MealsId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_OrdersMeals_Meals_MealsId",
                        column: x => x.MealsId,
                        principalTable: "Meals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrdersMeals_Orders_OrdersId",
                        column: x => x.OrdersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealsIngredients_MealsId",
